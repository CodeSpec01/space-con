const Privacy = () => {
  return (
    <div className="w-full min-h-screen gap-5 flex flex-col text-white items-center">
      <h1 className="text-[10vw] md:text-[8vw] text-center mt-[12vh] ">Privacy Policy</h1>
      <div className="w-[90%] md:w-[80%]">
        ...
        <br />
        <h2 className="text-[#6356fd] text-[8vw] md:text-[3vw] ">
          Interpretation and Definitions
        </h2>
        <h3 className="text-[#6356fd] text-[5vw] md:text-[2vw] ">Interpretation</h3>
        <p>
        ...
        <br />
        <h3 className="text-[#6356fd] text-[5vw] md:text-[2vw] ">Definitions</h3>
        ...
        <ol className="list-decimal ml-5">
          ...
          <li>
            ...
            "We", "Us" or "Our" in this Agreement&#41; refers to Spacecon.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to Spacecon, accessible from
            spacecon.org
          </li>
          <li>
        ...
        <h3 className="text-[#6356fd] text-[5vw] md:text-[2vw] ">Types of Data Collected</h3>
        <h3 className="text-[#6356fd] text-[5vw] md:text-[2vw] ">Personal Data</h3>
        <br />
        <p>
        ...
        <br />
        <h3 className="text-[#6356fd] text-[5vw] md:text-[2vw] ">Usage Data</h3>
        <p>
        ...
        <br />
        <h3 className="text-[#6356fd] text-[5vw] md:text-[2vw]">
        ...
        <br />
        <h3 className="text-[#6356fd] text-[5vw] md:text-[2vw]">Use of Your Personal Data</h3>
        ...
        <h3 className="text-[#6356fd] text-[5vw] md:text-[2vw]">Business Transactions </h3>
        <p>
        ...
        <br />
        <h3 className="text-[#6356fd] text-[5vw] md:text-[2vw]">Law enforcement</h3>
        <p>
        ...
        <br />
        <h3 className="text-[#6356fd] text-[5vw] md:text-[2vw]">Other legal requirements</h3>
        <p>
        ...
        <h2 className="text-[#6356fd] text-[8vw] md:text-[3vw] ">Children's Privacy</h2>
        <p>
        ...
        <h2 className="text-[#6356fd] text-[8vw] md:text-[3vw] ">Links to Other Websites</h2>
        <p>
        ...
        <h2 className="text-[#6356fd] text-[8vw] md:text-[3vw] ">Contact Us</h2>
        <p>
          If you have any questions about this Privacy Policy, You can contact
          us:{" "}
        </p>
        <ul className="list-disc ml-5">
          <li>By email: spacecon@nsut.ac.in</li>
        </ul>
      </div>
    </div>
  );
