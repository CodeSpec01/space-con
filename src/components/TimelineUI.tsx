    ...
    >
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="relative pl-20 pr-4 md:pl-20 w-full">
              <h3 className="md:hidden block text-2xl mb-4 text-left font-bold text-[#6356fd]">
                {item.title}
              </h3>
              {item.content}{" "}
            </div>
        ...
        <div
          ...
          className="absolute md:left-8 left-8 top-0 overflow-hidden w-[5px] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[0%] via-neutral-700 to-transparent to-[99%]  [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)] "
        >
          <motion.div
            style={{
